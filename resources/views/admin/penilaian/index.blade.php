...
@push('styles')
    ...
    <style>
        ...
        .sub-table td { padding: 14px 15px; font-size: 13px; border-bottom: 1px solid #f1f5f9;}
        ...
        .badge { padding: 5px 12px; border-radius: 20px; font-size: 11px; font-weight: 700; display: inline-flex; align-items: center; text-align: center;}
        ...
        .btn-nilai-main { background: #1e3a8a; color: white; padding: 8px 16px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 12px; display: inline-flex; align-items: center; gap: 6px; width: 140px; justify-content: center;}
        .btn-update-main { background: #eff6ff; color: #1e3a8a; padding: 8px 16px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 12px; display: inline-flex; align-items: center; gap: 6px; border: 1px solid #1e3a8a; width: 140px; justify-content: center;}
