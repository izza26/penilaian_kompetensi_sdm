...
@section('page_title', 'Tim Saya & Skoring')
@section('page_subtitle', 'Ambil alih dan pantau antrean penilaian skoring seluruh pegawai')
...
<style>
    ...
    .badge-penilai { background-color: #fff1f2; color: #e11d48; font-weight: 700; padding: 8px 16px; border-radius: 50px; font-size: 12px; border: 1px solid #fecaca; }
    ...
    <div class="page-card">
        <div class="page-title-header">
            ...
            <div class="badge-penilai">
                <i class="bi bi-shield-lock-fill me-1"></i> Mode Takeover: {{ Auth::user()->pegawai_nama ?? 'Super Administrator' }}
            </div>
        </div>
                ...
                <tbody>
                    @forelse($data_pegawai as $pid => $peg)
                        ...
                        <tr class="parent-row" onclick="toggleChild('child-{{ $pid }}', this)">
                            ...
                            <td>
                                <b style="color: var(--primary); font-size: 14px;">{{ $peg['pegawai_nama'] ?? $peg['nama'] }}</b><br>
                                <span style="font-size: 11px; color: #94a3b8;">NIP: {{ $peg['nip_nik'] ?? $pid }}</span>
                            </td>
                            ...
                            <td style="text-align: center;" onclick="event.stopPropagation();">
                                ...
                                @elseif($semua_selesai)
                                    <a href="{{ route('admin.tim_saya.beri_nilai', [$pid, $shortcut_kode]) }}" class="btn-update-main" style="width: 120px;">
                                        <i class="bi bi-pencil-square"></i> Ubah Nilai
                                    </a>
                                @else
                                    <a href="{{ route('admin.tim_saya.beri_nilai', [$pid, $shortcut_kode]) }}" class="btn-nilai-main" style="width: 120px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        @elseif($uk['is_dinilai'])
                                                            <a href="{{ route('admin.tim_saya.beri_nilai', [$pid, $uk['kode_unit']]) }}" class="btn-update-main" style="width: 100px;">
                                                                <i class="bi bi-pencil-square"></i> Ubah Nilai
                                                            </a>
                                                        @else
                                                            <a href="{{ route('admin.tim_saya.beri_nilai', [$pid, $uk['kode_unit']]) }}" class="btn-nilai-main" style="width: 100px;">
                    ...
                    @empty
                        <tr><td colspan="6" style="text-align: center; padding: 50px 20px; color: #94a3b8;"><i class="bi bi-funnel" style="font-size: 36px; display:block; margin-bottom:12px; color: #cbd5e1;"></i><span style="font-size: 14px; font-weight: 500;">Tidak ada antrean penilaian.</span></td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
