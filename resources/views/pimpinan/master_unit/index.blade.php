...
<div class="page-card">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 25px;">
        ...
        <a href="{{ route('pimpinan.master_unit.create') }}" class="btn-add-main" style="text-decoration:none; display:inline-block;">
...
<div id="modalUnit" class="modal">
    <div class="modal-content">
        ...
        <form method="POST" action="{{ route('pimpinan.master_unit.action') }}">
...
<form id="formHapus" method="POST" action="{{ route('pimpinan.master_unit.action') }}" style="display:none;">
