...
<div class="profil-container">
        ...
        <div class="hero-right">
            <div class="profile-summary">
                ...
                <div class="summary-item" style="margin-bottom:0;">
                    ...
                    <strong style="color: #3e54a0;">{{ $rataRataSkor }}</strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-section">
        ...
        <div class="info-grid">
            ...
            <div class="info-card"><span>Role Otoritas</span><h4><span style="color:#3e54a0; font-weight:700;"><i class="bi bi-shield-check"></i> {{ ucfirst($pimpinan->role) }}</span></h4></div>
    ...
    <div class="card-section" style="margin-bottom: 0;">
        ...
        <div class="setting-grid">
            ...
            <a href="#" class="setting-card" onclick="alert('Fitur ubah password akan segera hadir!'); return false;">
                <div class="setting-icon" style="background:#fff1f2; color:#e11d48;"><i class="bi bi-key-fill"></i></div>
                <div>
