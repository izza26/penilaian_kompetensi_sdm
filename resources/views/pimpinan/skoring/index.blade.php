...
<style>
    ...
    .jabatan-badge { 
        background: #f8fafc; color: #475569; padding: 6px 14px; border-radius: 50px; 
        font-size: 11px; font-weight: 600; border: 1px solid #e2e8f0; display: inline-block; text-align: center;
    }
                                        ...
                                        <tbody>
                                            @foreach($peg['uks'] as $uk)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <!-- TOMBOL LEVEL 2 MATI JIKA BELUM UPLOAD -->
                                                        @if($uk['terkumpul'] == 0)
